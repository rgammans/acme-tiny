...
This is a fork of https://github.com/diafygi/acme-tiny, intended to work in
mostly the same manner as the orignal, but with a few additional features to
ease integration with my acme-engine scripts.

A Secondary objective will be to try improve the code readability at the expense
of line count.
